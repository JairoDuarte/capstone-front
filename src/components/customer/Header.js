...
export default class HeaderComponent extends Component {
  ...
  render() {
    ...
    const RenderNotification = () => {
            ...
            <Grid divided columns="equal">
              <Grid.Column>
                <Popup
                  trigger={
                    <Button
                      onClick={() => this.props.acceptSkheraService(skhera)}
                      color="grs"
                      content="Accepte"
                      fluid
                    />
              ...
              <Grid.Column>
                <Popup
                  trigger={
                    <Button
                      onClick={() => this.props.declineSkheraService(skhera)}
                      color="grl"
                      content="Decline"
                      fluid
                    />
      ...
      ) : this.props.user.role === COURSIER_ROLE ? (
        <RenderStatus />
      ) : (
      ...
      return this.props.menus.map(item => {
        return (
          <>
            ...
            >
              <Button
                onClick={() => this.props.setMenu(item.label)}
                color={this.setcolor(item.label)}
                primary={false}
                as={Link}
                to={item.url}
                style={{
