    ...
    return (
      <Menu className='' style={{ textAlign:'left', marginLeft: '1em' }}  secondary vertical>
       ...
       <Menu.Item style={{ marginRight: '0.0em', marginLeft: '0.0em', padding: '0px 0px' }} >
        <Button onClick={()=>this.handleClick('My Skhera')} color={this.setcolor('My Skhera')} primary={false} as={Link} to='/profile/skhera' style={{ fontWeight: 'normal', textAlign:'left', width: '212px',  fontFamily: 'Ropa Sans', marginLeft: '0em', padding: '1.4em 2em' }}>
        <span>My Skhera</span>
        </Button>
                  
       </Menu.Item>
       <Menu.Item as={Link} to='/profile' style={{ marginRight: '0.0em', marginLeft: '0.0em', padding: '0px 0px' }} >
       ...
       <Menu.Item style={{ marginRight: '0.0em', marginLeft: '0.0em', padding: '0px 0px' }} >
        <Button onClick={() => this.handleClick('My Adresse')} color={this.setcolor('My Adresse')} primary={false} as='a' style={{ fontWeight: 'normal', textAlign:'left', width: '212px',  fontFamily: 'Ropa Sans', marginLeft: '0em', padding: '1.4em 2em' }}>
        <span>My Adresse</span>
        </Button>
