    ...
    render() {
        ...
        return (
            <Container textAlign='center' text>
                ...
                />
                <Button onClick={this.closeConfigShow(CUSTOMER_ROLE)} size='huge' color='grs' style={{ marginTop: mobile ? '53px' : '', marginLeft: mobile ? '0em' : '1.0em', height: '55px', width: mobile ? '90%' : '300px' }}>
                    <Icon name='home' />
                ...
                {mobile ? <div><br /></div> : ''}
                <Button onClick={this.closeConfigShow(COURSIER_ROLE)} size='huge' color='grl' primary={false} as='a' style={{ marginLeft: mobile ? '0em' : '1.0em', height: '55px', width: mobile ? '90%' : '300px' }}>
                ...
                >
                    <Modal.Content>
                        ...
                        <FacebookLogin
                            ...
                            render={
                                renderProps => (
                                    <Button onClick={renderProps.onClick} size='huge' color='facebook' primary={false} as='a' style={{ marginBottom: '2em', marginTop: '1em', marginLeft: mobile ? '1em' : '5em' }}>
