...
export default function Footer({ mobile }) {
  return (
    <Menu vertical={!!mobile} text style={{ width: '100%' }}>
      <Container style={{ marginTop: '2em', marginBottom: '49px' }}>
        {mobile ? (
          ...
          <Menu.Item>
            ...
            <Image
              href="/"
              alt="logo"
              style={{ marginLeft: '1em', height: '36px', width: '112px' }}
        ...
        <Menu.Menu position="right">
          ...
          ></Menu.Item>
          <Menu.Item name="Privacy Policy" position="right" as="a" style={{ color: '#000000', fontSize: '16px' }} />
          {!mobile ? (
            ''
          ) : (
            <Menu.Item>
