...
const GettingStartedGoogleMap = withGoogleMap(props => (
  <GoogleMap ref={props.onMapLoad} defaultZoom={5} defaultCenter={{ lat: 41.85, lng: -117.65 }}>
...
export default class Map extends Component {
  ...
  mapUpdate = () => {
    if (
      this.props.from.coordinates[0] !== this.state.coordinatesFrom[0] ||
      this.props.from.coordinates[1] !== this.state.coordinatesFrom[1] ||
      this.props.to.coordinates[0] !== this.state.coordinatesTo[0] ||
      this.props.to.coordinates[1] !== this.state.coordinatesTo[1]
    ) {
      this.handleMapLoad();
    }
  };
  ...
  render() {
    const time = `${this.state.duration.text} `;
            ...
            >
              <tr>
                <th style={{ padding: '0em 0em', marginRight: '10em' }}>
                  ...
                  <div style={{ textAlign: 'left', marginTop: '-1em', fontSize: '14px', fontWeight: 'normal' }}>
                ...
                <th style={{ width: '150px' }}>
                  ...
                  <div style={{ textAlign: 'right', marginTop: '-1em', fontSize: '14px', fontWeight: 'normal' }}>
                    ~{duration()} min / {this.state.distance.text}
                  </div>
                </th>
              </tr>
            </Segment>
